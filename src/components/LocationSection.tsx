      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-gray-600 font-rounded space-y-1">
                    <p>Segunda a Sexta: 08:30 às 12:00 - 13:30 às 18:30</p>
                    <p>Sábados: 08:30 às 16:00 (sem fechar ao meio dia)</p>
          ...
          <div className="card-candy p-2 h-64 sm:h-80 md:h-96 lg:h-full lg:min-h-[400px] order-first lg:order-last">
            <iframe
              src="https://maps.google.com/maps?q=Rua%20do%20Comércio,%20954,%20Centro,%20Ibirubá%20RS,%2098200-000&t=&z=17&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="100%"
